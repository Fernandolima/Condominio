...
<html lang="pt_BR">
	<head>
		...
		<link rel="shortcut icon" href="<c:url value = "/webstatic/img/favicon.jpg"/>" type="image/x-icon" />
	...
	<body id="login-view">
		<section id="login">
			...
			<form action="j_spring_security_check" id="frmLogin" method="post">
				...
				<img src="<c:url value = "/webstatic/img/load-login.gif"/>" id="load-login" alt="carregando" />
			</form>
