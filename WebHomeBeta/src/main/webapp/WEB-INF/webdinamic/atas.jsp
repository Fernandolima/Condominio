                	...
                	<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Cadastrar Atas</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form:form modelAttribute="bean" class="form-horizontal" action="/WebHomeBeta/admin/atas/addArquivos" method="post" id="frmAtas" enctype="multipart/form-data">
                                      <fieldset>
                                        <legend>Atas</legend>                                        
                                        	<div class="control-group">
	                                        	<form:label class="control-label" for="tituloAta" path="atasTo.titulo">Título </form:label>
	                                          	<div class="controls">
	                                          		<form:input type="text" id="tituloAta" path="atasTo.titulo" placeholder="Digite o título" autocomplete="off" class="span6" />
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="control-group">
                                          		...
                                          		<div class="controls">
                                            		<form:input type="text" id="date01" path="data" autocomplete="off" placeholder="Data da Ata" value=" " class="input-xlarge datepicker" />
                                            	</div>
                                        	</div>
