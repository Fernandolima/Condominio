	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				</a> <a class="brand" href="/WebHomeBeta/admin">Web Home - Área
					Administrativa</a>
				...
				<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					<sec:authorize access="hasRole('ROLE_ADMIN')">
						<li class="active"><a href="/WebHomeBeta/admin"><i
								class="icon-chevron-right"></i>Página Principal</a></li>
						...
						<li><a href="/WebHomeBeta/admin/listarEspaco"><i
								class="icon-chevron-right"></i> Listar Espaços</a></li>
						<li><a href="/WebHomeBeta/admin/espaco"><i
								class="icon-chevron-right"></i> Cadastrar Espaços</a></li>
