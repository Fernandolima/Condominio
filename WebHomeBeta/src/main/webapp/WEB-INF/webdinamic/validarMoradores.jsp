                	...
                	<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Moradores pendentes de aprovação</div>
                            </div>
						              ...
						              <tbody>
						                <c:forEach items="${listaUsuarios}" var="item">
						                	<tr>
						                		...
						                		<td class="link"><a href="/WebHomeBeta/admin/validarMoradores/login=${item.login}/proc" class="btn btn-primary">Visualizar</a></td>           		
						                	</tr>
						                </c:forEach>
						              </tbody>
						            </table>
